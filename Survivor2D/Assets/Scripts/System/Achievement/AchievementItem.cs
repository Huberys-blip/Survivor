...
namespace ProjectSurvicor
{
         ...
         public AchievementItem Condition(Func<bool> condition)
 {
     ...
     return this;
        ...
        public AchievementItem WithDescriptione(string description)
        {
            Description = description;
            return this;
        }
        public AchievementItem WithmOnUnlocked(Action<AchievementItem> monUnlocked)
        {
            mOnUnlocked = monUnlocked;
            return this;
        }
